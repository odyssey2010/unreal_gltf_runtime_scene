...
void UglTFRuntimeComponent::BuildMesh()
{
	if (!Asset)
	{
		return;
...
void UglTFRuntimeComponent::ProcessNode(USceneComponent* NodeParentComponent, const FName SocketName, FglTFRuntimeNode& Node)
{
...
void UglTFRuntimeComponent::SetCurveAnimationByName(const FString& CurveAnimationName)
{
...
// Called every frame
void UglTFRuntimeComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UglTFRuntimeComponent::ReceiveOnStaticMeshComponentCreated_Implementation(UStaticMeshComponent* StaticMeshComponent, const FglTFRuntimeNode& Node)
{

}

void UglTFRuntimeComponent::ReceiveOnSkeletalMeshComponentCreated_Implementation(USkeletalMeshComponent* SkeletalMeshComponent, const FglTFRuntimeNode& Node)
{
